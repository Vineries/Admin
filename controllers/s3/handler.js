var CryptoJS = require("crypto-js"),
    ...
    serverPublicKey = process.env.AWS_ACCESS_KEY,
    serverSecretKey = process.env.AWS_ACCESS_SECRET,
    aws = require("aws-sdk"),
    // Set these two values to match your environment
    expectedBucket = process.env.S3_BUCKET_NAME,
    expectedHostname = `${process.env.S3_BUCKET_NAME}.s3.amazonaws.com`,
